...
from lit_jais_init.utils import get_batch, build_prompt, adapter_state_from_state_dict
from lit_jais_init.modeling_jais import JAISLMHeadModel
...
log_interval = 1
run_name = f'{args.note}Jais_init{learning_rate}_{data_path}_{args.d}device'
print(run_name)
